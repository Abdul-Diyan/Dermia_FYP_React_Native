...
export default function RootLayout() {
  ...
  // Prevent rendering until fonts are fully loaded to avoid production crashes
  if (!fontsLoaded && !error) {
    return null;
  }
  ...
  return (
    <ThemeProvider value={colorScheme === "dark" ? DarkTheme : DefaultTheme}>
      {/* By passing screenOptions here, it automatically applies to all 
        files in your app directory (landing_page, login_page, etc.) 
      */}
